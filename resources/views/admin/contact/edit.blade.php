                        ...
                        <form action="{{ route('contact.update', '1') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" value="{{ $item['address'] }}" class="form-control" id="address"  placeholder="Մուտքագրել հասցե">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" name="fb_link" value="{{ $item['fb_link'] }}" class="form-control" id="fb_link"  placeholder="Մուտքագրել Facebook-ի հղում">
                                </div>
                                <div class="form-group">
                                    <label for="insta_link">Instagram-ի հղում:</label>
                                    <input type="url" name="insta_link" value="{{ $item['insta_link'] }}" class="form-control" id="insta_link"  placeholder="Մուտքագրել Instagram-ի հղում">
                                </div>
                                <div class="form-group">
                                    <label for="ld_link">Linkedin-ի հղում:</label>
                                    <input type="url" name="ld_link" value="{{ $item['ld_link'] }}" class="form-control" id="ld_link"  placeholder="Մուտքագրել Linkedin-ի հղում">
                                </div>
                                <div class="form-group">
                                    <label for="tw_link">Twitter-ի հղում:</label>
                                    <input type="url" name="tw_link" value="{{ $item['tw_link'] }}" class="form-control" id="tw_link"  placeholder="Մուտքագրել Twitter-ի հղում">
                                </div>
                            </div>
